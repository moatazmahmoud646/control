...
<body>
  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
     ...
     <!-- insert image-->
     <center>
   <h1 style="text-align:center; color:#000">Add Fruit</h1>
...
//display image into page and insert all date into table item
...
<form action="#" method="post" enctype="multipart/form-data">
  ...
  Fruit Name:       <input type="text"  name="name" required ><br><br>
  Fruit Description:<textarea           name="descrip"   cols="30" rows="2" required></textarea><br><br>
  Fruit cure:    <input type="text"  name="cure" required ><br><br>
