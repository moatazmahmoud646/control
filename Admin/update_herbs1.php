...
{
  $sql_query="SELECT * FROM item WHERE type='herb' and id=".$_GET['edit_id'];
...
if(isset($_POST['btn-update']))
{
  ...
  $sql_query = "UPDATE item SET name='$name',description='$description',cure='$cure',cost='$cost',quantity='$quantity',feature='$feature' WHERE type='herb' and id=".$_GET['edit_id'];
  // sql query for update data into database
  ...
  if(mysql_query($sql_query))
  {
    ...
    window.location.href='update_herbs.php';
    </script>
    <?php
  }
  else
...
{
  header("Location: update_herbs.php");
}
?>
